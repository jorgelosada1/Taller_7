    ...
    <main class="form-signin w-100 m-auto">
      <form action="register_product" method="post">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="product_name" name="product_name" placeholder=" Ingrese el nombre de su producto" required autofocus pattern="[A-Za-z ]{2,40}">
          <label  for="product_name" >nombre: </label>
        </div>

        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="product_value" name="product_value" placeholder=" Ingrese el precio de su producto" required autofocus >
          <label  for="product_value" >precio: </label>

        </div>

        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="category_id" name="category_id" placeholder=" Ingrese el id de su categoria" required autofocus >
